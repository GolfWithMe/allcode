...
class CommunityGroupscheduleController extends CommunityBaseController
{
    var $task;
    var $_icon = 'groupschedule';
    var $_name = 'groupschedule';
    ...
    public function groupschedule()
    {
        ...
        $view = $this->getView('groupschedule', '', $viewType);
        ...
        echo $view->get('groupschedule', $data);
    }
