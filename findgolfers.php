...
class CommunityFindgolfersController extends CommunityBaseController
{
    var $task;
    var $_icon = 'findgolfers';
    var $_name = 'findgolfers';
    ...
    public function viewpartner()
    {
        ...
        $view = $this->getView('findgolfers', '', $viewType);
        $model = $this->getModel('findgolfers');
        ...
        echo $view->get('viewpartner', $data);
    }
    ...
    public function findpartner()
    {
        ...
        echo $view->get('findpartner', $data);
    }
